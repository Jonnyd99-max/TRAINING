...
const makeScene = () => ({ id: crypto.randomUUID().replaceAll('-', ''), kind: 'image', title: 'Untitled scene', subtitle: '', image: null, narration: '', caption: '', duration: 5, manual_duration: false, voice: 'en-GB-SoniaNeural', speed: 0, audio: null, audio_key: null, audio_duration: null });
