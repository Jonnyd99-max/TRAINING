...
const makeScene = (voice = 'piper:en_GB-northern_english_male-medium') => ({ id: crypto.randomUUID().replaceAll('-', ''), kind: 'image', title: 'Untitled scene', subtitle: '', image: null, narration: '', caption: '', subtitles_enabled: true, duration: 5, manual_duration: false, voice, speed: 0, audio: null, audio_key: null, audio_duration: null });
